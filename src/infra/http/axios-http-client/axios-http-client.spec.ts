...
describe('AxiosHttpClient', () => {
  describe('post', () => {
    test('Should call axios.post with corret values', async () => {
    ...
    test('Should return the correct response on axios.post', async () => {
      const { sut, mockedAxios } = makeSut()
      const httpResponde = await sut.post(mockPostRequest())
  ...
  describe('get', () => {
    test('Should call axios.get with corret values', async () => {
    ...
    test('Should call axios.get with corret reponse ', async () => {
      const { sut, mockedAxios } = makeSut()
      const httpResponde = await sut.get(mockGetRequest())
