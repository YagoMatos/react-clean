...
import { AddAccountSpy, Helper, UpdateCurrentAccountMock, ValidationStub } from '@/presentation/test/index'
...
describe('Signup Component', () => {
  ...
  test('Should show valid name state if Validation successeds', () => {
    const { sut } = makeSut()
    Helper.populateField(sut, 'name')
  ...
  test('Should show valid passwordConfirmation state if Validation successeds', () => {
    const { sut } = makeSut()
    Helper.populateField(sut, 'passwordConfirmation')
  ...
  test('Should present error if AddAccount falis', async () => {
    const { sut, addAccountSpy } = makeSut()
